...
public class EasyClickLauncherWidgetReceiver extends BroadcastReceiver {
...
//					AppManager.getInstance().getListEvents().add(eventWrapper);
	...
	private void updateWidgetPictureAndButtonListener(Context context) {
		...
		remoteViews.setOnClickPendingIntent(R.id.widget_up_button,
				EasyClicktLauncherWidgetProvider.buildUpButtonPendingIntent(
						context));

		remoteViews.setOnClickPendingIntent(R.id.widget_left_button,
				EasyClicktLauncherWidgetProvider.buildLeftButtonPendingIntent(
						context));

		remoteViews.setOnClickPendingIntent(R.id.widget_down_button,
				EasyClicktLauncherWidgetProvider.buildDownButtonPendingIntent(
						context));

		remoteViews.setOnClickPendingIntent(R.id.widget_right_button,
				EasyClicktLauncherWidgetProvider
...
//							.buildLunchEventBtnPendingIntent(context, event.getPatter()));
		...
		EasyClicktLauncherWidgetProvider.pushWidgetUpdate(
